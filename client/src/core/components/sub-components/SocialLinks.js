    ...
    return (
        <div className="social-media">
            ...
            <div className="d-flex">
                ...
                <a href="https://www.linkedin.com/company/e-cell-kiet/" className="linkedin pe-5" target="_blank">
                    <img src={linkedinIcon} width="20px" height="20px" alt="linkedin link" />
                </a>
                <a href="https://www.instagram.com/kietecell/?igshid=lbrt09aprj0l" className="instagram pe-5" target="_blank">
                    <img src={instagramIcon} width="20px" height="20px" alt="instagram link" />
                </a>
                <a href="https://www.youtube.com/channel/UCpKWoJOSPr3rxTbPHx_kbaw" className="youtube pe-5" target="_blank">
