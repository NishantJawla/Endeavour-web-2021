    ...
    return (
        <div className="privacy-policy bg-sec-pattern bg-norepeat py-5">
            <div className="container py-5">
                <div className="heading-font pt-5 pb-3 text-center color-white fw-bold">Terms Of Service</div>
                <div className="privacy-policy-content color-white py-3 text-justify">
                    <div className="fs-5 fw-bold pb-3 ls-1">Overview</div>
                    <div className="fs-6">
                        This website is operated by <strong>e-Cell KIET</strong>. Throughout the site, the terms “we”, “us” and “our” refer to <strong>e-Cell KIET</strong>. We offer this website, including all information, tools and services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies and notices stated here.<br/>
                    ...
                    <div className="fs-5 fw-bold pt-4 pb-3 ls-1">SECTION 1 - ONLINE PURCHASE TERMS</div>
                    <div className="fs-6">
                    ...
                    <div className="fs-5 pt-4 fw-bold pb-3 ls-1">SECTION 2 - GENERAL CONDITIONS</div>
                    <div className="fs-6">
                    ...
                    <div className="fs-5 pt-4 fw-bold pb-3 ls-1">SECTION 3 - MODIFICATIONS TO THE SERVICE AND PRICES</div>
                    <div className="fs-6">
                    ...
                    <div className="fs-5 pt-4 fw-bold pb-3 ls-1">SECTION 4 - ACCURACY OF BILLING AND ACCOUNT INFORMATION</div>
                    <div className="fs-6">
                        We reserve the right to refuse any order you place with us. We may, in our sole discretion, limit or cancel quantities purchased per person, per institution or per order. These restrictions may include orders placed by or under the same customer account or the same credit card. In the event that we make a change to or cancel an order, we may attempt to notify you by contacting the e-mail or the phone number provided at the time the purchase was made. We reserve the right to limit or prohibit orders that, in our sole judgment, appear to be placed by dealers, resellers or distributors. <br />
                    ...
                    <div className="fs-5 pt-4 fw-bold pb-3 ls-1">SECTION 5 - OPTIONAL TOOLS</div>
                    <div className="fs-6">
                        We may also, in the future, offer new services and/or features through the website (including, the release of new tools and resources). Such new features and/or services shall also be subject to these Terms of Service    
                    </div>
                    <div className="fs-5 pt-4 fw-bold pb-3 ls-1">SECTION 6 - USER COMMENTS, FEEDBACK AND OTHER SUBMISSIONS</div>
                    <div className="fs-6">
                    ...
                    <div className="fs-5 pt-4 fw-bold pb-3 ls-1">SECTION 7 - PERSONAL INFORMATION</div>
                    <div className="fs-6">
                        Your submission of personal information through the order is governed by our Privacy Policy.
                    </div>
                    <div className="fs-5 pt-4 fw-bold pb-3 ls-1">SECTION 8 - ERRORS, INACCURACIES AND OMISSIONS</div>
                    <div className="fs-6">
                        Occasionally there may be information on our site or in the Service that contains typographical errors, inaccuracies or omissions that may relate to event descriptions, pricing, promotions, offers,  and availability. We reserve the right to correct any errors, inaccuracies or omissions, and to change or update information or cancel purchase if any information in the Service or on any related website is inaccurate at any time without prior notice (including after you have submitted your order). <br/>
                        We undertake no obligation to update, amend or clarify information in the Service or on any related website, including without limitation, pricing information, except as required by law. No specified update or refresh date applied in the Service or on any related website, should be taken to indicate that all information in the Service or on any related website has been modified or updated. <br/>

                    </div>
                    <div className="fs-5 pt-4 fw-bold pb-3 ls-1">SECTION 9 - PROHIBITED USES</div>
                    <div className="fs-6">
                    ...
                    <div className="fs-5 pt-4 fw-bold pb-3 ls-1">SECTION 10 - DISCLAIMER OF WARRANTIES; LIMITATION OF LIABILITY</div>
                    <div className="fs-6">
                    ...
                    <div className="fs-5 pt-4 fw-bold pb-3 ls-1">SECTION 11 - INDEMNIFICATION</div>
                    <div className="fs-6">
                        You agree to indemnify, defend and hold harmless against e-Cell KIET and our parent, affiliates, partners, officers, directors, agents, contractors, licensors, service providers, subcontractors, sponsors, harmless from any claim or demand, including reasonable attorneys’ fees, made by any third-party due to or arising out of your breach of these Terms of Service or the documents they incorporate by reference, or your violation of any law or the rights of a third-party.
                    </div>
                    <div className="fs-5 pt-4 fw-bold pb-3 ls-1">SECTION 12 - SEVERABILITY</div>
                    <div className="fs-6">
                        In the event that any provision of these Terms of Service is determined to be unlawful, void or unenforceable, such provision shall nonetheless be enforceable to the fullest extent permitted by applicable law, and the unenforceable portion shall be deemed to be severed from these Terms of Service, such determination shall not affect the validity and enforceability of any other remaining provisions.
                    </div>
                    <div className="fs-5 pt-4 fw-bold pb-3 ls-1">SECTION 13- TERMINATION</div>
                    <div className="fs-6">
                    ...
                    <div className="fs-5 pt-4 fw-bold pb-3 ls-1">SECTION 14 - ENTIRE AGREEMENT</div>
                    <div className="fs-6">
                        ...
                        These Terms of Service and any policies or operating rules posted by us on this site or in respect to The Service constitutes the entire agreement and understanding between you and us and govern your use of the Service, superseding any prior or contemporaneous agreements, communications and proposals, whether verbal or written, between you and us (including, but not limited to, any prior versions of the Terms of Service). <br/>
                        Any ambiguities in the interpretation of these Terms of Service shall not be construed against the drafting party. <br/>
                    </div>
                    <div className="fs-5 pt-4 fw-bold pb-3 ls-1">SECTION 15 - GOVERNING RULE</div>
                    <div className="fs-6">
                        The failure of us to exercise or enforce any right or provision of these Terms of Service shall not constitute a waiver of such right or provision. <br/>
                        These Terms of Service and any policies or operating rules posted by us on this site or in respect to The Service constitutes the entire agreement and understanding between you and us and govern your use of the Service, superseding any prior or contemporaneous agreements, communications and proposals, whether verbal or written, between you and us (including, but not limited to, any prior versions of the Terms of Service). <br/>
                        Any ambiguities in the interpretation of these Terms of Service shall not be construed against the drafting party.
                    </div>
                    <div className="fs-5 pt-4 fw-bold pb-3 ls-1">SECTION 16 - CHANGES TO TERMS OF SERVICE</div>
                    <div className="fs-6">
                    ...
                    <div className="fs-5 pt-4 fw-bold pb-3 ls-1">SECTION 17 - CONTACT INFORMATION</div>
                    <div className="fs-6">
                    Questions about the Terms of Service should be sent to us at <strong>ecell@kiet.edu</strong>
                    </div>
                </div>
            </div>
        </div>
