            ...
            <div className=" m-5 p-5 rounded-3 bg-white">
                ...
                <div class="details">
                    <div className="each-line row py-2">
                        ...
                        <input className="form-control col-9 " type="text" placeholder="name" name="name" readOnly={!edit} value={props.data.name}/>
                    </div>
                    <div className="each-line row py-2">
                        <label className=" col-3 align-self-center ls-1 fs-6 fw-bold">Email</label>
                        <input className="form-control col-9 " type="email" placeholder="email" name="email" readOnly={!edit} value={props.data.email} />
                    </div>
                    <div className="each-line row py-2">
                        <label className=" col-3 align-self-center ls-1 fs-6 fw-bold">Phone Number</label>
                        <input className="form-control col-9 " type="tel" placeholder="1234567890" name="phoneNumber" readOnly={!edit} value={props.data.phoneNumber} />
                    </div>
                    <div className="each-line row py-2">
                        <label className=" col-3 align-self-center ls-1 fs-6 fw-bold">Endeavour Id</label>
                        <input className="form-control col-9 " type="text" placeholder="ENDVR20211234567890" name="endvrid" readOnly={!edit} value={props.data.endvrid} />
                    </div>
                    <div className="each-line row py-2">
                        <label className=" col-3 align-self-center ls-1 fs-6 fw-bold">Semester</label>
                        <input className="form-control col-9 " type="text" placeholder="Semester" name="semester" readOnly={!edit} value={props.data.semester} />
                    </div>
                    <div className="each-line row py-2">
                        <label className=" col-3 align-self-center ls-1 fs-6 fw-bold">Confirmed</label>
                        <input className="form-control col-9 " type="text" placeholder="true/false" name="confirmed" readOnly={!edit} value={props.data.confirmed} />
                    </div>
                    <div className="each-line row py-2">
                        <label className=" col-3 align-self-center ls-1 fs-6 fw-bold">Profile</label>
                        <input className="form-control col-9 " type="text" placeholder="true/false" name="profile" readOnly={!edit} value={props.data.profile} />
                    </div>
                    <div className="each-line row py-2">
                        <label className=" col-3 align-self-center ls-1 fs-6 fw-bold">College</label>
                        <input className="form-control col-9 " type="text" placeholder="College Name" name="college" readOnly={!edit} value={props.data.college} />
                    </div>
                    <div className="each-line row py-2">
                        <label className=" col-3 align-self-center ls-1 fs-6 fw-bold">Discord Id</label>
                        <input className="form-control col-9 " type="text" placeholder="Pranav#1234" name="discord" readOnly={!edit} value={props.data.discord} />
                    </div>
                    <div className="each-line row py-2">
                        <label className=" col-3 align-self-center ls-1 fs-6 fw-bold">Event Pass</label>
                        <input className="form-control col-9 " type="text" placeholder="true/false" name="eventPass" readOnly={!edit} value={props.data.eventPass} />
                    </div>
                    <div className="each-line row py-2">
                            ...
                            <div className="d-flex flex-wrap justify-content-around">
                                {
                                    ...
                                    props.data.myEvents.map(event => {
                                        return (<li className="p-1">{event.eventName}</li>);
                    ...
                    <div className="each-line row py-2">
                        ...
                        <button className="btn col btn-danger fs-6 ls-1 py-3 ms-2">Delete</button>
                    </div>
                </div>
            </div>
        </div>
